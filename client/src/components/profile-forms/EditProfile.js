...
const EditProfile = ({
  ...
  useEffect(() => {
    ...
    if (!loading && profile) {
      ...
      if (Array.isArray(profileData.likings))
        profileData.likings = profileData.likings.join(', ');
  ...
  return (
      <Fragment>
        ...
        Edit Your Citizen Profile
        </h1>
        <p className="lead">
          <i className="fas fa-user"></i> Edit your Gotham
          citizen profile as you like!
        </p>
